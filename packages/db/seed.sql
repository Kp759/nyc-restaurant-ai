...
insert into media_items (restaurant_id, media_type, source, url, thumbnail_url, caption, creator_name, creator_url, rights_status, moderation_status) values
  ('11111111-1111-1111-1111-111111111101', 'photo', 'restaurant', 'https://images.example.com/lilias/hero.jpg', 'https://images.example.com/lilias/hero-thumb.jpg', 'The candlelit back room', null, null, 'owned', 'approved'),
  ('11111111-1111-1111-1111-111111111101', 'embed', 'tiktok', 'https://www.tiktok.com/@food/video/1000000000000000001', 'https://images.example.com/lilias/tiktok-thumb.jpg', 'Spicy rigatoni close-up', 'nycpastaguy', 'https://www.tiktok.com/@nycpastaguy', 'embedded', 'approved'),
  ('11111111-1111-1111-1111-111111111102', 'photo', 'restaurant', 'https://images.example.com/mott/interior.jpg', 'https://images.example.com/mott/interior-thumb.jpg', 'Marble tables, morning light', null, null, 'owned', 'approved'),
  ('11111111-1111-1111-1111-111111111102', 'embed', 'youtube', 'https://www.youtube.com/shorts/aaaaaaaaaa1', 'https://images.example.com/mott/yt-thumb.jpg', 'Matcha pour', 'sohocafes', 'https://youtube.com/@sohocafes', 'embedded', 'approved'),
  ('11111111-1111-1111-1111-111111111103', 'photo', 'creator', 'https://images.example.com/rotolo/table.jpg', 'https://images.example.com/rotolo/table-thumb.jpg', 'Weeknight buzz', 'evdiner', 'https://instagram.com/evdiner', 'licensed', 'approved'),
  ('11111111-1111-1111-1111-111111111104', 'photo', 'restaurant', 'https://images.example.com/kura/counter.jpg', 'https://images.example.com/kura/counter-thumb.jpg', 'The twelve-seat counter', null, null, 'owned', 'approved'),
  ('11111111-1111-1111-1111-111111111104', 'embed', 'tiktok', 'https://www.tiktok.com/@sushi/video/1000000000000000004', 'https://images.example.com/kura/tiktok-thumb.jpg', 'Otoro nigiri', 'bksushi', 'https://www.tiktok.com/@bksushi', 'embedded', 'approved'),
  ('11111111-1111-1111-1111-111111111105', 'photo', 'restaurant', 'https://images.example.com/ferns/plants.jpg', 'https://images.example.com/ferns/plants-thumb.jpg', 'Plant-filled back room', null, null, 'owned', 'approved'),
  ('11111111-1111-1111-1111-111111111106', 'photo', 'creator', 'https://images.example.com/dimes/noodles.jpg', 'https://images.example.com/dimes/noodles-thumb.jpg', 'Late-night dan dan', 'lesnights', 'https://instagram.com/lesnights', 'licensed', 'approved'),
  ('11111111-1111-1111-1111-111111111107', 'photo', 'restaurant', 'https://images.example.com/quill/room.jpg', 'https://images.example.com/quill/room-thumb.jpg', 'The hushed dining room', null, null, 'owned', 'approved'),
  ('11111111-1111-1111-1111-111111111108', 'photo', 'restaurant', 'https://images.example.com/highline/rooftop.jpg', 'https://images.example.com/highline/rooftop-thumb.jpg', 'Skyline at sunset', null, null, 'owned', 'approved'),
  ('11111111-1111-1111-1111-111111111108', 'embed', 'tiktok', 'https://www.tiktok.com/@rooftops/video/1000000000000000008', 'https://images.example.com/highline/tiktok-thumb.jpg', 'Sunset spritz', 'nycrooftops', 'https://www.tiktok.com/@nycrooftops', 'embedded', 'approved'),
  ('11111111-1111-1111-1111-111111111109', 'photo', 'restaurant', 'https://images.example.com/sotto/bar.jpg', 'https://images.example.com/sotto/bar-thumb.jpg', 'The pasta bar', null, null, 'owned', 'approved'),
  ('11111111-1111-1111-1111-111111111110', 'embed', 'tiktok', 'https://www.tiktok.com/@dessert/video/1000000000000000010', 'https://images.example.com/nook/tiktok-thumb.jpg', 'Pistachio soft serve', 'nycsweets', 'https://www.tiktok.com/@nycsweets', 'embedded', 'approved'),
  ('11111111-1111-1111-1111-111111111110', 'photo', 'restaurant', 'https://images.example.com/nook/cone.jpg', 'https://images.example.com/nook/cone-thumb.jpg', 'The famous cone', null, null, 'owned', 'approved');
